...
output "test" {
  value = var.test["stacks/_spacelift/policies/trigger/new-stack-trigger"].executionRoleArn == null ? "test" : var.test["stacks/_spacelift/policies/trigger/new-stack-trigger"].executionRoleArn
}
