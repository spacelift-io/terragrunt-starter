...
output "test" {
  value = var.test["stacks/_spacelift/policies/trigger/new-stack-trigger"].executionRoleArn == null ? aws_iam_role.spacelift.arn : var.test["stacks/_spacelift/policies/trigger/new-stack-trigger"].executionRoleArn
}
